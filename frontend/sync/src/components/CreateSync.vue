<template>
  <div>
    <span class="headline blue-grey--text darken-1--text"
      >Creating a new Sync</span
    >
    ...
    <div id="stepperWrapper">
      <div id="stepper">
        <span class="subtitle-2 font-weight-bold blue-grey--text darken-1--text"
          >Step 1 of 4</span
        >
        <v-stepper
          v-model="currentStep"
          ...
          class="elevation-0"
        >
          <v-stepper-step :complete="currentStep > 1" step="1" class="step"
            >PLC</v-stepper-step
          >

          <v-stepper-step :complete="currentStep > 2" step="2" class="step"
            >Thing</v-stepper-step
          >

          <v-stepper-step :complete="currentStep > 3" step="3" class="step"
      ...
      <div id="stepperContent">
        ...
        <div class="actionBar mt-5">
          <v-btn @click="cancelCreation" color="default" text large
            >Cancel</v-btn
          >
          <v-btn
            outlined
